    ...
    <div class="card-body">
        <div class="container">
            ...
            <form action="{{ route('services.update', $service->id) }}" method="POST" enctype="multipart/form-data" class="mt-4">
                ...
                <div class="form-group mb-3">
                        <label for="title" class="form-label">Title</label>
                        <input type="text" name="title" id="title" placeholder="Title" class="form-control" value="{{$service->title}}" required>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group mb-3">
                        ...
                        <select name="type" id=""  class="form-control" required>
                            ...
                            <option value="policy" {{$service->type == "policy" ? 'selected' : ""}}>
                                Policies
                            </option>
                        </select>
                    </div>
                ...
                <div class="form-group mb-3">
                    ...
                    <textarea name="content" id="content" class="form-control summernote" rows="5">{{ old('content', $service->content) }}</textarea>
                </div>
