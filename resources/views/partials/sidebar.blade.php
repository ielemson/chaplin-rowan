<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="{{ route("home") }}" class="brand-link">
        <img src="{{ asset('img/logo.png') }}" alt="Palpressmedia" class="brand-image img-circle elevation-3" style="opacity: .8">
        <span class="brand-text font-weight-light"> Palpressmedia</span>
    </a>
